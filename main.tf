...
resource "google_compute_instance" "minecraft" {
  ...
  #metadata_startup_script = "docker run -d -p 25565:25565 -e EULA=TRUE -e MAX_MEMORY=3G -e JVM_OPTS='-Djava.net.preferIPv4Stack=true' -v /var/minecraft:/data --name mc --rm=true itzg/minecraft-server:latest;"
  metadata_startup_script = "docker run -d -p 25565:25565 -e EULA=TRUE -e MAX_MEMORY=3G -v /var/minecraft:/data --name mc --rm=true ashdev/minecraft-spigot:alpine;"
