...
resource "google_compute_instance" "minecraft" {
  ...
  metadata_startup_script = "docker run -d -p 25565:25565 -e EULA=TRUE -e MAX_MEMORY=3G -e TYPE=SPIGOT -e VERSION=1.15.2 -v /var/minecraft/spigot:/data --name mc --rm=true itzg/minecraft-server:latest;"
